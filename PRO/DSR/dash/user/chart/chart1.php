...
$sqlQuery="SELECT COUNT(foreign_teacher.name)AS num, collage.name AS cname FROM foreign_teacher INNER JOIN collage ON foreign_teacher.receive = collage.id  GROUP BY collage.name ";
